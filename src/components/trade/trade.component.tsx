...
export const TradeComponent = () => {
  ...
  const loaded =
    loadedResources.markets &&
    loadedResources.tickers &&
    loadedResources.balance;
  ...
  return (
    <>
      ...
      <GridBlockComponent
        title={
          <div className="flex items-center">
            <div>
              <span className="font-bold mr-2">Trade</span>
      ...
      >
        {loaded ? (
          <>
            <div className="px-2 pt-3 select-none">
              <Select
                id="select-trade-type"
                instanceId="select-trade-type"
                className="react-select-container bg-dark-bg uppercase font-bold rounded-md"
