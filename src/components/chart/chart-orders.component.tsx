...
import { OrderSide, OrderType, PositionSide } from 'gvm-cex/dist/types';

import { selectedOrdersAtom, selectedPositionsAtom } from '../../app-state';
...
export const ChartOrdersComponent = ({
  ...
  const orders = useAtomValue(selectedOrdersAtom);
  const positions = useAtomValue(selectedPositionsAtom);
