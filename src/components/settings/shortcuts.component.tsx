  ...
  return (
    <div className="px-2 py-3 relative overflow-hidden">
      ...
      <div className={editing ? 'blur-sm' : ''}>
        ...
        <div className="w-1/2 text-center text-dark-text-gray text-sm mt-2 mb-1">
          The buy/sell news shortcuts needs to be enabled in the{' '}
          <Link href="/?modal=settings&tab=news-trading" className="underline">
