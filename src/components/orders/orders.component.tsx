...
import { loadedAtom, ordersAtom, selectedOrdersAtom } from '../../app-state';
...
const TableRowComponent = (props: Record<string, any>) => (
...
export const OrdersComponent = () => {
  ...
  const symbolOrders = useAtomValue(selectedOrdersAtom);
