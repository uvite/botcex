...
import { OrderType, PositionSide } from 'gvm-cex/dist/types';

import { selectedPositionsAtom, selectedTickerAtom } from '../../app-state';
...
export const simpleOrdersTradeAtom = atom((get) => {
  ...
  const positions = get(selectedPositionsAtom);
